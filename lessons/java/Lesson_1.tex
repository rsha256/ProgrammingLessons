...
\item Download the installer to a known location (ex. \underline{Downloads} or \underline{Desktop})
...
\begin{enumerate}
\item Start up Eclipse and make the workspace in a known location (ex. \underline{Documents})
...
order to assign values to our variables we must \textbf{initialize} them. We can
...
value ``Aravind". This is an example of initializing a variable. It is important
