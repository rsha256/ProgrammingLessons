...
\begin{document}
\title{Lesson 3 Solutions}%Insert Title here
\author{Tim Magoun and Aravind Koneru}
\date{\textit{Compiled on} \today \hspace{1mm} at \currenttime}
\maketitle

\inputminted{java}{../../src/ps_3/tables.java}

\inputminted{java}{../../src/ps_3/range.java}

\inputminted{java}{../../src/ps_3/bubbleSort.java}
